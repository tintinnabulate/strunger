...
// defined, strunger will create a new self-contained Go source file implementing
...
//
//	//go:generate strunger -type=Pill
//
...
//
package main // import "github.com/tintinnabulate/strunger"
...
func Usage() {
	...
	fmt.Fprintf(os.Stderr, "\tstrunger [flags] -type T [directory]\n")
	fmt.Fprintf(os.Stderr, "\tstrunger [flags] -type T files... # Must be a single package\n")
	fmt.Fprintf(os.Stderr, "For more information, see:\n")
	fmt.Fprintf(os.Stderr, "\thttp://godoc.org/golang.org/x/tools/cmd/strunger\n")
...
func main() {
	...
	g.Printf("// Code generated by \"strunger %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
	g.Printf("\n")
...
const stringMap = `func (i %[1]s) String() string {
	...
	foo := "%[1]s(" + strconv.FormatInt(int64(i), 10) + ")"
